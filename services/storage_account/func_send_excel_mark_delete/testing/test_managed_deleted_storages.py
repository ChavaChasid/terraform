...
from project.managed_deleted_storages import (
    return_first_row,
    upload_to_table,
    update_deleted_storages_in_table,
    deleted_storages,
...
@patch("project.managed_deleted_storages.connection_string", "connection_string")
@patch("project.managed_deleted_storages.deleted_accounts_table", "aa")
@patch(
    "project.managed_deleted_storages.update_deleted_storages_in_table",
    Mock(return_value=""),
)
@patch(
...
@patch(
    "project.managed_deleted_storages.return_first_row",
...
def test_update_deleted_storages_in_table(upload_to_table):
    update_deleted_storages_in_table(
